        ...
        >
          ...
          >
              ...
              >
                ...
                >
                  ...
                  <Grid item xs={6} sm={6} md={6} lg={6}>
                    ...
                    >
                      <Typography style={Subtitle}>Quantity</Typography>
                    </InputLabel>
                    <OutlinedInput
                      disabled={loadingStatus}
                      required
                ...
                >
                  ...
                  <Grid item xs={6} sm={6} md={6} lg={6}>
                    <InputLabel
                      style={{ marginBottom: "0.2rem", width: "100%" }}
                    >
                      <Typography style={{ ...Subtitle, color: "transparent" }}>
                        Quantity
                      </Typography>
                    </InputLabel>
                    <Button
            ...
            >
              ...
              >
                <Typography style={GrayButtonText}>Go back</Typography>
              </Button>
              <Button
                onClick={() => assignDeviceToStaffMember()}
                style={{ ...BlueButton, ...CenteringGrid, width: "100%" }}
              >
                <Typography style={BlueButtonText}>Assign equipment</Typography>
              </Button>
            </Grid>
          </Grid>
        </Modal>
