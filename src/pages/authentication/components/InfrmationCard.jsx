    ...
    return (
        <Card
            ...
            <Grid display={'flex'} justifyContent={'space-between'} alignItems={'center'} item xs={12} sm={12} md={12} lg={12}>
                <Typography color='var(--Gray-900, #101828)'
                    fontFamily='Inter'
                    fontSize='18px'
                    fontStyle='normal'
                    fontWeight='600'
            ...
            <Grid item xs={12} sm={12} md={12} lg={12}><Typography color='var(--Gray-900, #101828)'
                ...
                lineHeight='28px'
                textAlign={'left'}
            >{props.name} {props.lastName}</Typography></Grid>
            <Grid item xs={12} sm={12} md={12} lg={12}><Typography color='var(--Gray-600, #475467)'
                fontFamily='Inter'
                fontSize='16px'
                fontStyle='normal'
                fontWeight='400'
