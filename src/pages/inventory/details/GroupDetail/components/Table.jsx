...
const TableDeviceLocation = ({ searchItem, referenceData }) => {
    ...
    const listItemsQuery = useQuery({
        ...
        queryFn: () => devitrakApi.post("/db_item/current-inventory", { company_name: user.company, item_group: decodeURI(location.search.slice(1)) }),
        enabled: false,
    ...
    const itemsInInventoryQuery = useQuery({
        ...
        queryFn: () => devitrakApi.post("/db_item/consulting-item", {
            ...
            item_group: decodeURI(location.search.slice(1))
        }),
        enabled: false,
        refetchOnMount: false
    })
    ...
    }, [itemsInInventoryQuery.data, dataStructuringFormat().length, location.key])
