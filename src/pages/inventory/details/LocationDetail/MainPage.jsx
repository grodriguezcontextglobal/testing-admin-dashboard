    ...
    return (
        ...
        >
            <Grid
                ...
                container
            >
                <Grid marginY={0} display={"flex"} justifyContent={'flex-start'} alignItems={'center'} item xs={12} sm={12} md={6}>
                    <Typography
            ...
            <Grid container>
                <Grid
                    ...
                    xs={12}
                >
                    <TableDeviceLocation searchItem={watch('searchDevice')} referenceData={setReferenceData} />
                </Grid>
            </Grid>
        </Grid>
    )
