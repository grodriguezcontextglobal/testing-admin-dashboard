...
const MainPageWarehouse = () => {
  ...
  const warehouse = location.search.split("&");
  const { register, watch, setValue } = useForm({
    defaultValues: {
      searchDevice: decodeURI(warehouse[1].split("=")[1]),
    },
  });
    ...
    >
      ...
      >
        <Grid
          ...
          md={6}
        >
          <Typography style={TextFontSize30LineHeight38}>Warehouse</Typography>
        </Grid>
        <Grid
          textAlign={"right"}
        ...
        <Grid marginY={0} item xs={12} sm={12} md={8}>
          ...
          >
            ...
            >
              ...
              {decodeURI(warehouse[0].slice(1)) ? "In stock" : "In use"}
            </Typography>
          </Grid>
        </Grid>
      ...
      >
        ...
        >
          <Typography style={TextFontSize30LineHeight38}>
            Inventory {decodeURI(warehouse[0].slice(1)) ? "in stock" : "in use"}
          </Typography>
        </Grid>
        <Grid
          display={"flex"}
