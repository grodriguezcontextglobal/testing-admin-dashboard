    ...
    return (
        ...
        >
            ...
            >
                ...
                {
                    optionToRender === 0 ? <SingleDevice setCreateTransactionPaid={setCreateTransactionChargeOption} /> : <MultipleDevices setCreateTransactionPaid={setCreateTransactionChargeOption} />
                }
            </div>
        </Modal>
    );
