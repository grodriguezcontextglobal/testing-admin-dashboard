    ...
    return (
        <>
            ...
            >
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: "1px", width: "100%" }}>
                    <OutlinedInput disabled={clientSecret !== ""} {...register("serialNumber")} autoFocus={true} style={{ ...OutlinedInputStyle, width: "90%" }} placeholder="Scan serial number here." />
                    <OutlinedInput disabled={clientSecret !== ""} style={{ ...OutlinedInputStyle, width: "90%" }} type="text" placeholder="Amount to authorize." {...register('amount', { required: true })} />
                </div>
