...
const SingleDevice = ({ setCreateTransactionForNoRegularUser }) => {
    ...
    return (
        ...
        >
            ...
            <form
                style={{ margin: " 0.5rem auto", display: "flex", flexDirection: "column", justifyContent: "space-between", alignItems: "center", gap: "0.5rem", alignSelf: "stretch", width: "100%" }}
