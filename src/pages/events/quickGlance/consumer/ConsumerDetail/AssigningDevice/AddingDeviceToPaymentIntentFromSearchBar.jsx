  ...
  const handleDevicesAssignedToPaymentIntentInEvent = async (data) => {
    ...
    try {
      if (checkDeviceIsAssignedInEvent()) {
        const resp = await devitrakApiAdmin.post("/receiver-assignation", template);
  ...
  return (
    ...
    >
      ...
      <Grid
        ...
        container
      >
        <Grid style={{ width: "100%", display: "flex", justifyContent: "flex-start", alignItems: "center" }} item xs={11} sm={11} md={11} lg={11}>
          <OutlinedInput
        ...
        <Grid style={{ width: "100%", display: "flex", justifyContent: "flex-end", alignItems: "center" }} item xs sm md lg>
          <Button
            disabled={submittedAction}
            style={BlueButton}
            type="submit"
